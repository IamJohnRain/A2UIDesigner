...
#ifndef A2UI_COLUMN_COMPONENT_H
#define A2UI_COLUMN_COMPONENT_H
...
public:
    ...
    std::shared_ptr<ColumnTheme> GetTheme();
...
private:
    // Theme cache
    std::weak_ptr<ColumnTheme> cachedTheme_;
