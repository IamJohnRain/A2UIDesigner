...
ImageTheme::ImageTheme(const ThemeContext& context) : ThemeBase(context)
{
    InitializeAllProperties();
}

void ImageTheme::OnConfigChange(const ThemeContext& context)
{
    InitializeAllProperties();
}

void ImageTheme::InitializeAllProperties()
{
    // DFX: Print theme context information
    LOG_A2UI(LOG_INFO,
        "ImageTheme::InitializeAllProperties - hasBrandColor=%{public}s, brandColor=0x%{public}x, "
