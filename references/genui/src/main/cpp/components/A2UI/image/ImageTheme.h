...
#ifndef A2UI_IMAGE_THEME_H
#define A2UI_IMAGE_THEME_H
...
/**
 * @brief Image component theme configuration
 */
class ImageTheme : public ThemeBase {
public:
    explicit ImageTheme(const ThemeContext& context);
