...
#ifndef A2UI_SLIDER_THEME_H
#define A2UI_SLIDER_THEME_H
...
/**
 * @brief Slider component theme configuration
 */
class SliderTheme : public ThemeBase {
public:
    explicit SliderTheme(const ThemeContext& context);
