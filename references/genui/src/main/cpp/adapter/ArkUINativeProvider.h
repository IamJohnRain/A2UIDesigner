...
#ifndef A2UI_ARKUI_NATIVE_PROVIDER_H
#define A2UI_ARKUI_NATIVE_PROVIDER_H

#include "IArkUINativeProvider.h"

namespace NativeModule {

class ArkUINativeProvider : public IArkUINativeProvider {
public:
    ArkUINativeProvider() = default;
    ~ArkUINativeProvider() override = default;
...
#endif // A2UI_ARKUI_NATIVE_PROVIDER_H
