...
#ifndef A2UI_NATIVE_GET_RADIO_VALUE_FUNCTION_H
#define A2UI_NATIVE_GET_RADIO_VALUE_FUNCTION_H
...
class NativeGetRadioValueFunction : public NativeFunctionBase {
public:
...
#endif // A2UI_NATIVE_GET_RADIO_VALUE_FUNCTION_H
