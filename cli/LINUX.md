...
| 架构 | 轻量版 | 完整离线版 |
|---|---|---|
| x64 | `a2ui-card-renderer-linux-x64-light-v0.3.0.tar.gz` | `a2ui-card-renderer-linux-x64-full-v0.3.0.tar.gz` |
| ARM64 | `a2ui-card-renderer-linux-arm64-light-v0.3.0.tar.gz` | `a2ui-card-renderer-linux-arm64-full-v0.3.0.tar.gz` |
...
```bash
tar -xzf a2ui-card-renderer-linux-arm64-full-v0.3.0.tar.gz
